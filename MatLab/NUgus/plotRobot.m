function pass = plotRobot(index,model,params)
    ...
    quiver3(0,0,0,a,0,0,"LineWidth",1,'Color','#379203');   % Z Vector
    quiver3(0,0,0,0,a,0,"LineWidth",1,'Color','r');         % X Vector
    ...
    plot3(rBER(3),rBER(1),rBER(2),'bo','LineWidth',2,'MarkerSize',10);
    plot3(rBEL(3),rBEL(1),rBEL(2),'ro','LineWidth',2,'MarkerSize',10);
...
%% OTHER JOINTS & LINKS
    ...
    plot3(rLB0(3),rLB0(1),rLB0(2),'rx','LineWidth',2,'markersize',10);

    plot3([rBEL(3), rLB0(3)],[rBEL(1), rLB0(1)],[rBEL(2), rLB0(2)],... % Link B-0
          'k','LineWidth',2);
    rRB0 = HTs.ARB0(1:3,4);                     % BASE RIGHT
    plot3(rRB0(3),rRB0(1),rRB0(2),'bx','LineWidth',2,'markersize',10);
    ...
    axis([ CM(3)-a, CM(3)+a, CM(1)-a, CM(1)+a, -0.01 0.5]);
    plot3(CM(3),CM(1),CM(2),'mo','MarkerSize',15,'LineWidth',3);
    drawnow
    pass = 1;
end